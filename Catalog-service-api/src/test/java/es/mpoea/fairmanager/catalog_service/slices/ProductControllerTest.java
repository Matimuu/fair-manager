...
//
//        when(productService.createProduct(command)).thenReturn(createdProduct);
...
//
//        verify(productService, times(1)).createProduct(command);
...
//
//        when(productService.updateProduct(1L, command)).thenReturn(updatedProduct);
...
//                .andExpect(jsonPath("$.updatedAt").value(updatedAt.toString()));
//
//        verify(productService, times(1)).updateProduct(1L, command);
...
//        UpdateProductCommand command = productMapper.toUpdateProductCommand(request);
//
//        when(productService.updateProduct(1L, command)).thenThrow(new ProductNotFoundException(1L));
//
//        mockMvc.perform(
